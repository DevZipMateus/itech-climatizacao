    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <img src="/lovable-uploads/52aa5dee-9efe-404c-9fa0-93461b12f4d6.png" alt="WhatsApp" className="h-4 w-4 sm:h-5 sm:w-5" />
        ...
        >
          {[
            ...
            { 
              icon: () => <img src="/lovable-uploads/52aa5dee-9efe-404c-9fa0-93461b12f4d6.png" alt="WhatsApp" className="h-4 w-4 sm:h-6 sm:w-6 md:h-8 md:w-8 mx-auto" />, 
              title: 'Suporte', 
